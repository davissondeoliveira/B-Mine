...
if($user_request['idFollower'] != $_SESSION['user_id']){
...
if($user_request['idFollowee'] != $_SESSION['user_id']){
	$user_name=$_SESSION['name'];
	$user_rate=getPart(2,$user_request['rating']);
	$user_ll=getPart(1,$user_request['loveLanguage']);
	$user_av=getPart(1,$user_request['availability']);
	$user_date=getPart(1,$user_request['date']);
	$match_name=$_GET['name'];
	$match_rate=getPart(1,$user_request['rating']);
	$match_ll=getPart(2,$user_request['loveLanguage']);
	$match_av=getPart(2,$user_request['availability']);
	$match_date=getPart(2,$user_request['date']);
}
 ...
 <li class="active">Match View</li>
  ...
  <div class="row col-md-12">
		<div class="col-md-6">
			...
			<div class="col-md-8">
					<div class="container toTheRight">
							<div class="item active">
									<img src="assets/img/insert.jpg" class="img-circle crop" alt="DaviHI">
							</div>
					</div>
			</div>
			</div>
			<div class="col-md-4">
				<div class="toTheLeft">
				<h2 class="myTop bold"><?php print $match_name; ?></h2>
		...
		<div class="col-md-6">
			...
			<div class="col-md-4 toTheRight">
				<div style="margin-top: 350px;">
					<h2 class="myTop bold"><?php print $user_name; ?></h2>
